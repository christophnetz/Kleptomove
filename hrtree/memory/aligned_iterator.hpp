...
namespace hrtree { namespace memory {
  ...
  >
  class aligned_iterator : public std::iterator<
  ...
  template <
    ...
    size_t ALIGN
  >
  class aligned_iterator< const T, ALIGN >  : public std::iterator<
      std::random_access_iterator_tag, const T, ptrdiff_t, const T*, const T&
    >
  {
  public:
    static const size_t align = ALIGN;
